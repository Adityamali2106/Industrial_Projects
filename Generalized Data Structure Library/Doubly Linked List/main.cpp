...
template <typename T>
void DisplayMenu() {
    DoublyLLL<T> *dobj = new DoublyLLL<T>();
    ...
    while (1)
    {
        ...
        case 1:
            ...
            cin>>data;
            dobj -> InsertFirst(data);
            break;
        case 2:
            cout<<"---------------------------- Enter data to insert :     -----------------------------------------\n"; 
            cin>>data;
            dobj -> InsertLast(data);
            break;
        case 3:
            cout<<"---------------------------- Enter data to insert :     -----------------------------------------\n"; 
            cin>>data;
        ...
        case 12:
            ...
            cout<<dobj -> SearchFirstOccurrence(data)<<"\n";
            break;
        case 13:
            cout<<"-------------------------- Enter data to search :     -----------------------------------------\n";
            cin>>data;
            cout<<" Data found at position  :  \t";
            cout<<dobj -> SearchLastOccurrence(data)<<"\n";
            break;
        case 14:
            cout<<"-------------------------- Enter data to search :     -----------------------------------------\n";
            cin>>data;
            cout<<"All Occurrence of "<<data<<" is : \t";
            cout<<dobj -> SearchAllOccurrence(data)<<"\n";
            break;
        case 15:
            cout<<"-------------------   Thank You.... ----------------------\n";
            exit(0);
